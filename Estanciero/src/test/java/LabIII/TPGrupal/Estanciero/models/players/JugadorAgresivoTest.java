...
class JugadorAgresivoTest {
    ...
    void setUp(TestInfo test) {
        ...
        jugadorMock.setProvinciasPrioritarias(Arrays.asList("TUCUMAN", "CORDOBA", "BUENOS AIRES"));
    ...
    @Spy
    @InjectMocks
    JugadorAgresivo jugadorMock;
    @ParameterizedTest(name = "[Test {index}]")
    @MethodSource("parametrosComprar")
    @DisplayName("Comprar() en JugadorAgresivo")
    ...
    void mejorar() {
        Escritura eUno = new Escritura(19, "MENDOZA ZONA CENTRO", TipoCasilla.Escritura, 3400,
                ...
                false, null, "MENDOZA", "CENTRO", 0, 2000);
        ...
        boolean resultadoUno = eUno.getDueño().Mejorar();  // Este debe dar Ok
        boolean resultadoC = c.getDueño().Mejorar();  // Este debe fallar
        boolean resultadoee4 = eCuatro.getDueño().Mejorar(); //Este debe fallar


        assertEquals(true, resultadoUno);      //Debe dar ok xq es Escritura y su coste de mejora es menor a la condicion
        assertEquals(false, resultadoC);    //Debe fracasar por no ser una   Escritura
        assertEquals(false,resultadoee4); //Debe fallar xq es màs caro
    ...
    private static Stream<Arguments> parametrosComprar() {
        ...
        escrituraPrioritaria.setProvincia("TUCUMAN");
        ...
        Stream<Arguments> parametros = Stream.of(
                ...
                Arguments.of(escrituraPrioritaria, escrituraPrioritaria.getPrecio() * 2, true),     //Provincia prioritaria a precio x2
                Arguments.of(escrituraPrioritaria, escrituraPrioritaria.getPrecio() * 3, false),    //Provincia prioritaria a precio x3
                Arguments.of(ferrocarril, ferrocarril.getPrecio(), true),                           //Ferrocarril
                Arguments.of(compañia, compañia.getPrecio(), true)                                  //Compañia
        );
