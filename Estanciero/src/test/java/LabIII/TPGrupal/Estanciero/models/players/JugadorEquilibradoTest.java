...
class JugadorEquilibradoTest {
    ...
    @InjectMocks
    @Spy
    JugadorEquilibrado jugadorMock;
    ...
    void setUp(TestInfo test) {
        ...
        jugadorMock.setProvinciasPrioritarias(Arrays.asList("MENDOZA", "SANTA FE", "TUCUMAN"));
        jugadorMock.setDinero(5000);
        jugadorMock.setEstado(Estado.JUGANDO);

    }

    @ParameterizedTest(name = "[Caso {index}]")
    @MethodSource("parametrosComprar")
    @DisplayName("Comprar() en JugadorEquilibrado")
    ...
    void mejorar() {
        ...
        assertEquals(false,resultadoee4); //Debe fallar xq el costo de la mejora es de 5000 y el dinero del jugador es de 5000
    ...
    private static Stream<Arguments> parametrosComprar() {
        ...
        escrituraPrioritaria.setProvincia("MENDOZA");
