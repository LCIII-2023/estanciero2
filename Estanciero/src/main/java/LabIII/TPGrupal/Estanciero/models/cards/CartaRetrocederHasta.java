...
@Getter
@Setter
public class CartaRetrocederHasta extends Carta {
    //Atributos
    private int valor;


    //Constructor
    public CartaRetrocederHasta(int id, String descripcion, TipoCarta tipo, int valor) {
        super(id, descripcion, tipo);
        this.valor = valor;
    }

    public CartaRetrocederHasta() {
        this.valor = 0;
    }
