...
@Getter
@Setter
public class MarchePreso extends Casilla {
    //Atributos
    private String descripcion;


    //Constructor
    public MarchePreso(int id, String nombre, TipoCasilla tipo, String descripcion) {
    ...
    public void Accion(Jugador j) {
        ...
        //Muestra por consola lo que se hace en la casilla
        consola.MostrarInformacion(this.descripcion);

        //Encierra al jugador en la comisaria
